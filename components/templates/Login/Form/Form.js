...
const Form = () => {
  ...
  return (
    <form className="flex flex-col gap-10">
      <label className="text-[25px] text-primary font-bold font-primary">
        ورود
      </label>
      <div className="max-w-[400px] h-[58px] flex justify-between items-center border-2 rounded-3xl px-5">
        <input
          ...
          className="border-none outline-none w-full font-primary"
          value={identifier}
      ...
      <button
        className="w-[400px] bg-green-800 text-white font-semibold text-xl py-3 rounded-3xl font-primary"
